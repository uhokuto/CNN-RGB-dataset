...
class design:
	...
	def __init__(self, img_ch, img_h, img_w,output_dim,class_layers=class_layers):
		...
		self.cl_1 = class_layers.Conv_without_activation(img_ch, img_h, img_w,self.n_flt1, self.flt1_h, self.flt1_w, self.stride1, self.pad1 )
		...
		self.cl_2 = class_layers.Conv_without_activation(self.cl_1.y_ch, self.cl_1.y_h, self.cl_1.y_w, self.n_flt2, self.flt2_h, self.flt2_w, self.stride2, self.pad2 )
...
# -- 逆伝播 --
	def backpropagation(self,given_output):
		...
		self.cl_1.backward(self.cl_2.grad_x)
