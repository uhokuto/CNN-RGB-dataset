...
dogDir = 'C:/Users/uhoku/Dropbox/Python/CNN/catdog/img/1/'
catDir = 'C:/Users/uhoku/Dropbox/Python/CNN/catdog/img/0/'
...
no_of_class=2
correct,input_data = rgb_data.normalize(no_of_class)
...
dogDir = 'C:/Users/uhoku/Dropbox/Python/bag_of_visual_words/catdog/test_img/1/'
catDir = 'C:/Users/uhoku/Dropbox/Python/bag_of_visual_words/catdog/test_img/0/'
dataDir_list=[catDir,dogDir]
label_list=[0,1]

rgb_data2 = rgb_datasets.rgb(label_list,dataDir_list,img_h,img_w)
correct,input_data = rgb_data2.normalize(no_of_class)
...
flatten_imgs = rgb_data2.input_data

for i,(flat_image,pred,true) in enumerate(zip(flatten_imgs,predicts,trues)):
	
	ax = fig.add_subplot(5,4,i+1)
	
	image=flat_image.reshape(img_ch, img_h, img_w)
	trans_img=image.transpose(1,2,0)
	ax.imshow(trans_img)
	ax.axis("off")
	# 正解ラベルを取り出す
	if pred ==0:
