...
rgb_data = rgb_datasets_augment.rgb(label_list,dataDir_list,img_h,img_w)
no_of_class=2
...
input_train,correct_train,input_test,correct_test = rgb_data2.create_train_test(0.3)
...
#input_test2=input_test[index_rand,:]
#correct_test2=correct_test[index_rand]
