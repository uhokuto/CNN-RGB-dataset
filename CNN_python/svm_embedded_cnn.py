...
#import design_layers_cpmm_svc
#import design_layers_cp_svc
import design_layers_cpcp_svc
import rgb_datasets
...
cnn1 = design_layers_cpcp_svc.design(img_ch, img_h, img_w,output_dim)
...
#svcLayerのforwardにfitを書く
#出力の次元数を見直す
#以下のargmaxはpredict?
cnn1.forward_propagation(input_train,n_train)
count_train=cnn1.ol_1.svc_clf.score(cnn1.ol_1.y,np.argmax(correct_train, axis=1))
cnn1.forward_propagation(input_test,n_test)
count_test=cnn1.ol_1.svc_clf.score(cnn1.ol_1.y,np.argmax(correct_test, axis=1))
